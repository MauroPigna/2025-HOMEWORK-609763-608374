...
class LabirintoBuilderTest {
	...
	public void testBilocale() {
		...
		assertTrue(Collections.singletonList("nord").containsAll(bilocale.getStanzaIniziale().getDirezioni()));
		assertTrue(Collections.singletonList("sud").containsAll(bilocale.getStanzaVincente().getDirezioni()));
	}
